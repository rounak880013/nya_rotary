...
import './Leader.css';
import image1 from "../assests/leader Rectangle 2577.png"
import image2 from "../assests/leader Rectangle 2579.png"
import image3 from "../assests/leader Rectangle 2581.png"
import image4 from "../assests/leader Rectangle 2583.png"
const Leader = () => {
  return (
    <>
...
Rotary is led by a diverse international team of top executives. Whether developing Rotary policy, providing financial support, managing a global staff, or advancing Rotary’s strategic plan, each member of the team is dedicated to helping our members connect and take action to create sustainable change.
    ...
    <div className="about_leader_a">
      <div className="about_leader_b">
      <img  src={image1} alt="Avatar"/>
      </div>
      <div className="about_leader_c">
        <div className="about_leader_d">
          Shekhar Mehta
        </div>
        <div className="about_leader_e">
          President 2021-22
        </div>
        <div className="about_leader_f">
