import './History.css';
import image1 from "../assests/about image 38.png"
function History(){
    return(
        <>
...
Over time, Rotary’s reach and vision gradually extended to humanitarian service. Members have a long track record of addressing challenges in their communities and around the world.
    ...
    <div className="about_b_a">
      <div className="about_b_a_a">
      “Whatever Rotary may mean to us, to the world it will be known by the results it achieves.”
      </div>
      <div className="about_b_a_b">
        <div className="about_b_a_b_a">
        <img  src={image1} alt="Avatar"/>
        <div className="about_b_a_b_b">
          Paul Harris <br/>Rotary founder
        </div>
        </div>
      </div>
    </div>
